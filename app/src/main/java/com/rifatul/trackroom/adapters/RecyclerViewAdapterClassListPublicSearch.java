...
public class RecyclerViewAdapterClassListPublicSearch extends RecyclerView.Adapter<RecyclerViewAdapterClassListPublicSearch.ViewHolder> {
    ...
    public RecyclerViewAdapterClassListPublicSearch(List<ItemClass> itemClassesPublic) {
